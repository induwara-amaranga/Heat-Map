...
app.get("/heatmap/map-data", (req, res) => {
  res.json({
    data: [
      { id: "B1",  count: 29 }, { id: "B2",  count: 75 }, { id: "B3",  count: 95 },
      { id: "B4",  count: 40 }, { id: "B5",  count: 21 }, { id: "B6",  count: 120 },
      { id: "B7",  count: 22 }, { id: "B8",  count: 80 }, { id: "B9",  count: 12 },
      { id: "B10", count: 10 }, { id: "B11", count: 58 }, { id: "B12", count: 95 },
      { id: "B13", count: 15 }, { id: "B14", count: 55 }, { id: "B15", count: 88 },
      { id: "B16", count: 25 }, { id: "B17", count: 70 }, { id: "B18", count: 102 },
      { id: "B19", count: 20 }, { id: "B20", count: 60 }, { id: "B21", count: 10 },
      { id: "B22", count: 28 }, { id: "B23", count: 9 }, { id: "B24", count: 140 },
      { id: "B25", count: 5 }, { id: "B26", count: 66 }, { id: "B27", count: 122 },
